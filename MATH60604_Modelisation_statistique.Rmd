...
<!--chapter:end:02-regression-lineaire.Rmd-->

# Inférence basée sur la vraisemblance {#vraisemblance}

<!--chapter:end:03-vraisemblance.Rmd-->
...
<!--chapter:end:04-modeles-lineaires-generalises.Rmd-->
...
<!--chapter:end:05-donnees-correlees-longitudinales.Rmd-->
...
<!--chapter:end:06-modeles-lineaires-mixtes.Rmd-->
...
<!--chapter:end:08-complements.Rmd-->
