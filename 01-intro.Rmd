...
### Variables, types de données et graphiques
...
```{r histboxplot, cache = TRUE, echo = FALSE, fig.cap = "boîte à moustachesdu prix des billets au tarif Promo en fonction de la classe pour le jeu de données Renfe"}
renfe %>% subset(tarif == "Promo") %>%
...
```{r renfe-aed4, cache = TRUE,echo = FALSE, fig.cap = "boîte à moustachesdu prix de billets de train de Renfe en fonction de la destination et du type de train."}
...
```{r renfe-aed6, cache = TRUE, echo = TRUE, fig.cap = "boîte à moustachesdu prix en fonction du tarif et de la classe de billets de trains à haute vitesse de la Renfe."}
