...
```{r intconf, eval= TRUE, echo = FALSE, cache = TRUE, fig.width = 8, fig.height = 5, fig.cap = "Intervalles de confiance à 95\\% pour la moyenne d'une population normale $\\mathsf{No}(0,1)$. Environ 95 de ces 100 intervalles devraient inclure zéro."}
