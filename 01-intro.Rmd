...
renfe %>%
  ...
  summarise("durée moyenne" = mean(duree),
            ...
            "prix moyen" = mean(prix),
            "écart-type" = sd(prix)) %>%
  kbl(booktabs = TRUE, caption = "Statistiques descriptives de la durée de trajet et du prix du billet par type de billet et destination pour les trains grande vitesse du jeu de données $\\texttt{renfe}$.") %>% kable_styling()
```
