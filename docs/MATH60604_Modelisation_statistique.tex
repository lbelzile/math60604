...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# Manipulation de données, incluant %>%}
...
\NormalTok{renfe_promo <-}\StringTok{ }\NormalTok{renfe }\OperatorTok{%>%}\StringTok{ }\KeywordTok{subset}\NormalTok{(tarif }\OperatorTok{==}\StringTok{ "Promo"}\NormalTok{)}
\CommentTok{# Test-t et différence de moyenne}
\NormalTok{ttest <-}\StringTok{ }\KeywordTok{t.test}\NormalTok{(prix}\OperatorTok{~}\NormalTok{dest, }\DataTypeTok{data =}\NormalTok{ renfe_promo)}
...
\NormalTok{n <-}\StringTok{ }\KeywordTok{nrow}\NormalTok{(renfe_promo)}
\NormalTok{B <-}\StringTok{ }\FloatTok{1e4}
\NormalTok{ttest_stats <-}\StringTok{ }\KeywordTok{numeric}\NormalTok{(B) }
\NormalTok{ttest_stats[}\DecValTok{1}\NormalTok{] <-}\StringTok{ }\NormalTok{ttest}\OperatorTok{$}\NormalTok{statistic}
...
\NormalTok{  ttest_stats[i] <-}\StringTok{ }\KeywordTok{t.test}\NormalTok{(prix }\OperatorTok{~}\StringTok{ }\NormalTok{dest[}\KeywordTok{sample.int}\NormalTok{(}\DataTypeTok{n =}\NormalTok{ n)], }
                           \DataTypeTok{data =}\NormalTok{ renfe_promo)}\OperatorTok{$}\NormalTok{statistic}
\NormalTok{\}}
...
\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data =} \KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{statistique =}\NormalTok{ ttest_stats), }
       \KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{statistique)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_histogram}\NormalTok{(}\DataTypeTok{bins =} \DecValTok{30}\NormalTok{, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y=}\NormalTok{..density..), }\DataTypeTok{alpha =} \FloatTok{0.2}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_density}\NormalTok{() }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_vline}\NormalTok{(}\DataTypeTok{xintercept =}\NormalTok{ ttest_stats[}\DecValTok{1}\NormalTok{]) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{ylab}\NormalTok{(}\StringTok{"densité"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{stat_function}\NormalTok{(}\DataTypeTok{fun =}\NormalTok{ dnorm, }\DataTypeTok{col =} \StringTok{"blue"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{renfe }\OperatorTok{%>%}\StringTok{ }\KeywordTok{count}\NormalTok{(classe)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{renfe }\OperatorTok{%>%}\StringTok{ }\KeywordTok{group_by}\NormalTok{(type) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{tally}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{renfe }\OperatorTok{%>%}\StringTok{ }\KeywordTok{group_by}\NormalTok{(tarif) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{tally}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{renfe }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{subset}\NormalTok{(duree }\OperatorTok{>}\StringTok{ }\DecValTok{200}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(type, dest) }\OperatorTok{%>%}\StringTok{ }
...
\begin{Highlighting}[]
\NormalTok{renfe }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{subset}\NormalTok{(type }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"AVE"}\NormalTok{,}\StringTok{"AVE-TGV"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(type, dest) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{summarise}\NormalTok{(}\StringTok{"durée moyenne"}\NormalTok{ =}\StringTok{ }\KeywordTok{mean}\NormalTok{(duree), }
            \StringTok{"écart-type"}\NormalTok{ =}\StringTok{ }\KeywordTok{sd}\NormalTok{(duree),}
            \StringTok{"prix moyen"}\NormalTok{ =}\StringTok{ }\KeywordTok{mean}\NormalTok{(prix),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{renfe }\OperatorTok{%>%}\StringTok{ }\KeywordTok{subset}\NormalTok{(tarif  }\OperatorTok{!=}\StringTok{ "AdultoIda"}\NormalTok{) }\OperatorTok{%>%}
...
\NormalTok{renfe }\OperatorTok{%>%}\StringTok{ }\KeywordTok{subset}\NormalTok{(tarif  }\OperatorTok{==}\StringTok{ "Flexible"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{count}\NormalTok{(prix, classe)}
\end{Highlighting}
\end{Shaded}
