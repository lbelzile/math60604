...
\begin{tcolorbox}[enhanced jigsaw, colback=white, opacityback=0, colframe=quarto-callout-important-color-frame, titlerule=0mm, colbacktitle=quarto-callout-important-color!10!white, toptitle=1mm, arc=.35mm, rightrule=.15mm, coltitle=black, leftrule=.75mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Objectifs d'apprentissage}, breakable, bottomtitle=1mm, bottomrule=.15mm, opacitybacktitle=0.6, left=2mm, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, opacityback=0, colframe=quarto-callout-caution-color-frame, titlerule=0mm, colbacktitle=quarto-callout-caution-color!10!white, toptitle=1mm, arc=.35mm, rightrule=.15mm, coltitle=black, leftrule=.75mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Mise en garde}, breakable, bottomtitle=1mm, bottomrule=.15mm, opacitybacktitle=0.6, left=2mm, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, opacityback=0, colframe=quarto-callout-important-color-frame, titlerule=0mm, colbacktitle=quarto-callout-important-color!10!white, toptitle=1mm, arc=.35mm, rightrule=.15mm, coltitle=black, leftrule=.75mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, breakable, bottomtitle=1mm, bottomrule=.15mm, opacitybacktitle=0.6, left=2mm, toprule=.15mm]
...
\section{Tests dérivés de la vraisemblance}\label{testsvrais}
...
par exemple considérer un polynôme d'ordre \(k\) (ordinairement, on
...
par le logiciel est \[S^2=\mathsf{SC}_e/(n-p-1),\] où le dénominateur
est la taille de l'échantillon \(n\) moins le nombre de paramètres de la
moyenne \(\boldsymbol{\beta}\), soit \(p+1\).

\end{proposition}

\begin{refremark}[Invariance]
Une conséquence directe des propriétés des estimateurs du maximum de
vraisemblance est que les valeurs ajustées \(\widehat{y}_i\) pour deux
matrices de modèle \(\mathbf{X}_a\) et \(\mathbf{X}_b\) sont les mêmes
si elles engendrent le même espace linéaire, comme dans
...
\section{Coefficient de détermination}\label{coefR2}
