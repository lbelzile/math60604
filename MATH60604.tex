...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{images/02-ttest-DF_illustration_fr.png}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{introduction_files/figure-pdf/fig-datasaurus-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{introduction_files/figure-pdf/fig-densite-beta-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{introduction_files/figure-pdf/fig-normal-loc-echelle-1.pdf}
...
\includegraphics[width=0.5\linewidth,height=\textheight,keepaspectratio]{introduction_files/figure-pdf/fig-densite-Student-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{introduction_files/figure-pdf/fig-barplotrenfe-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{introduction_files/figure-pdf/fig-histrenfe-1.pdf}
...
{\centering \includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{images/01-intro-boiteamoustache.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{introduction_files/figure-pdf/fig-histboxplot-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{introduction_files/figure-pdf/fig-nuagedepoints-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{introduction_files/figure-pdf/fig-diagrammeqq2-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{introduction_files/figure-pdf/fig-renfeclt-1.pdf}
...
\includegraphics[width=0.9\linewidth,height=\textheight,keepaspectratio]{introduction_files/figure-pdf/fig-renfemeanCLT-1.pdf}
...
\begin{tcolorbox}[enhanced jigsaw, breakable, colbacktitle=quarto-callout-important-color!10!white, toprule=.15mm, leftrule=.75mm, colframe=quarto-callout-important-color-frame, bottomtitle=1mm, left=2mm, coltitle=black, toptitle=1mm, titlerule=0mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Objectifs d'apprentissage}, arc=.35mm, opacitybacktitle=0.6, colback=white, rightrule=.15mm, bottomrule=.15mm, opacityback=0]
...
\includegraphics[width=0.6\linewidth,height=\textheight,keepaspectratio]{images/xkcd2569_hypothesis_generation.png}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{images/estimand.jpg}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{images/estimator.jpg}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{images/estimate.jpg}
...
\includegraphics[width=0.7\linewidth,height=\textheight,keepaspectratio]{images/xkcd2581_health_stats.png}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{inference_files/figure-pdf/fig-samplevar-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{inference_files/figure-pdf/fig-unifsamp1-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{inference_files/figure-pdf/fig-uniformsamp2-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{inference_files/figure-pdf/fig-power-plots-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{inference_files/figure-pdf/fig-intconf-1.pdf}
...
\begin{tcolorbox}[enhanced jigsaw, breakable, colbacktitle=quarto-callout-caution-color!10!white, toprule=.15mm, leftrule=.75mm, colframe=quarto-callout-caution-color-frame, bottomtitle=1mm, left=2mm, coltitle=black, toptitle=1mm, titlerule=0mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Mise en garde}, arc=.35mm, opacitybacktitle=0.6, colback=white, rightrule=.15mm, bottomrule=.15mm, opacityback=0]
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{inference_files/figure-pdf/fig-puissance-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{inference_files/figure-pdf/fig-infer-odds-ratio-permutation-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{inference_files/figure-pdf/fig-renfepermut-1.pdf}
...
\begin{tcolorbox}[enhanced jigsaw, breakable, colbacktitle=quarto-callout-important-color!10!white, toprule=.15mm, leftrule=.75mm, colframe=quarto-callout-important-color-frame, bottomtitle=1mm, left=2mm, coltitle=black, toptitle=1mm, titlerule=0mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, arc=.35mm, opacitybacktitle=0.6, colback=white, rightrule=.15mm, bottomrule=.15mm, opacityback=0]
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{vraisemblance_files/figure-pdf/fig-attente-hist-1.pdf}
...
\textbf{cohérent}, c'est-à-dire qu'il approche de la vraie valeur du
paramètre inconnu à mesure que la taille de l'échantillon augmente
(asymptotiquement sans biais, convergence en probabilité).
...
mais les deux estimateurs sont cohérents et s'approcheront donc de la
...
\ell(\boldsymbol{\theta})&=-\frac{n}{2} \ln(2\pi)-\frac{n}{2} \ln (\sigma^2) -\frac{(\boldsymbol{y}-\mathbf{X}\boldsymbol{\beta})^\top(\boldsymbol{y}-\mathbf{X}\boldsymbol{\beta})}{2\sigma^2}.
\end{align*} Si on dénote par
\(\widehat{\boldsymbol{y}}=\mathbf{X}\widehat{\boldsymbol{\beta}}\) les
prédictions du modèle, maximiser la log-vraisemblance par rapport à
...
&\propto-\frac{n\ln\sigma^2}{2}-\frac{1}{2\sigma^2}(\boldsymbol{y}-\mathbf{X}\hat{\boldsymbol{\beta}})^\top(\boldsymbol{y}-\mathbf{X}\hat{\boldsymbol{\beta}}).
\end{align*} En dérivant chaque terme par rapport à \(\sigma^2\) et en
fixant le gradient à zéro, on obtient l'estimateur du maximum de
...
\begin{pmatrix}
 ...
 \end{pmatrix}
\end{align*} et l'information observée est la matrice \(2 \times 2\)
\begin{align*}
...
\end{align*} Pour calculer l'information de Fisher, on calcule
l'espérance de \(\mathsf{E}\{(Y/\lambda)^\alpha\},\)
\(\mathsf{E}[(Y/\lambda)^\alpha\ln\{(Y/\lambda)^\alpha\}]\) et
\(\mathsf{E}[(Y/\lambda)^\alpha\ln^2\{(Y/\lambda)^\alpha\}].\) Par
définition, \begin{align*}
...
\end{align*} après le changement de variable
\(S = (Y/\lambda)^\alpha\sim \mathsf{Exp}(1).\) Les deux autres
intégrales sont tabulées dans Gradshteyn et Ryzhik
(\citeproc{ref-Gradshteyn.Ryzhik:2014}{2014}), et valent \(1-\gamma\) et
\(\gamma^2-2\gamma + \pi^2/6,\) respectivement, où
\(\gamma \approx 0.577\) est la constante d'Euler--Mascherroni. Les
entrées de la matrice d'information de Fisher d'un échantillon aléatoire
simple Weibull sont \begin{align*}
...
\end{align*} L'information pour un échantillon de variables
indépendantes et identiquement distribuées est \(n\) fois celle d'une
seule variable, et l'information s'accumule à un taux linéaire.
...
\FunctionTok{data}\NormalTok{(attente, }\AttributeTok{package =} \StringTok{"hecmodstat"}\NormalTok{)}
...
\NormalTok{nll\_weibull }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(pars, y) \{}
  ...
  \ControlFlowTok{if}\NormalTok{ (}\FunctionTok{isTRUE}\NormalTok{(}\FunctionTok{any}\NormalTok{(pars }\SpecialCharTok{\textless{}=} \DecValTok{0}\NormalTok{))) \{}
    \FunctionTok{return}\NormalTok{(}\FloatTok{1e10}\NormalTok{) }\CommentTok{\# retourner une valeur large finie}
\CommentTok{\# (pour éviter les messages d\textquotesingle{}avertissement)}
\NormalTok{  \}}
...
\NormalTok{  ))}
\NormalTok{\}}
\CommentTok{\# Gradient du négatif de la log vraisemblance Weibull}
...
\CommentTok{\# La commande retourne TRUE si la dérivée numérique }
\CommentTok{\# égale sa version analytique à tolérance donnée}
...
\NormalTok{opt\_weibull }\OtherTok{\textless{}{-}} \FunctionTok{optim}\NormalTok{(}
  ...
  \CommentTok{\# passer la fonction à optimiser, son premier argument }
 \CommentTok{\# doit être le vecteur de paramètres}
  \AttributeTok{gr =}\NormalTok{ gr\_nll\_weibull,}
  \CommentTok{\# gradient (optionnel)}
  \AttributeTok{method =} \StringTok{"BFGS"}\NormalTok{,}
  \CommentTok{\# algorithme BFGS est basé sur le gradient, }
  \CommentTok{\# une alternative robuste est "Nelder"}
...
\CommentTok{\# retourner la matrice de dérivée secondes évaluée aux EMV}
\NormalTok{) }
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{images/likelihood_tests_fr.pdf}
...
\begin{refremark}[Procédures de tests et formes quadratiques]
D'où provient cette loi \(\chi^2_q\)? Considérons pour faire simple le
cas où \(q=2\) restrictions sont imposées dans un modèle avec \(p=2\)
paramètres (par ex., la loi de Weibull) et le test de Wald. La loi
asymptotique de l'estimateur du maximum de vraisemblance dicte que
\(\widehat{\boldsymbol{\theta}} \stackrel{\cdot}{\sim} \mathsf{normale}_p\{\boldsymbol{\theta}, i^{-1}(\boldsymbol{\theta})\},\)
et on peut obtenir des ellipses de confiance pour un test en remplaçant
l'information de Fisher \(i(\boldsymbol{\theta})\) par un estimateur
cohérent comme \(j(\widehat{\boldsymbol{\theta}})\): on obtient alors le
panneau de gauche de la Figure~\ref{fig-ellipses}.

Si on postule \(\boldsymbol{\theta} = \boldsymbol{\theta}_0,\) il suffit
de considérer où la valeur tombe sur le diagramme et le niveau de
l'ellipse correspondante. Plutôt, on peut standardiser et considérer la
variable standardisée
\(\boldsymbol{\vartheta} =j^{1/2}(\widehat{\boldsymbol{\theta}})(\widehat{\boldsymbol{\theta}}-\boldsymbol{\theta}_0),\)
dont les courbes de contour sont circulaires. Pour réduire le problème,
on considère le carré du rayon
...
qui suit une loi \(\chi^2_2.\) On peut ainsi facilement déterminer si la
valeur suggérée pour le paramètre \(\boldsymbol{\theta}_0\) est rare
sous l'hypothèse nulle, comme dans le panneau de droite de la
Figure~\ref{fig-ellipses}, puisque tous les valeurs rares deviennent des
rayons.
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{vraisemblance_files/figure-pdf/fig-ellipses-1.pdf}

}

\caption{\label{fig-ellipses}Courbes de contour elliptiques pour la loi
asymptotique normale multidimensionnelle des EMV (gauche) et densité du
carré du rayon des variables standardisés \(\boldsymbol{\vartheta},\)
avec les niveaux des quantiles correspondant indiqués par des traits
(droite).}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{vraisemblance_files/figure-pdf/fig-weibull-profile-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{vraisemblance_files/figure-pdf/fig-qqplots-weibull-exp-1.pdf}
...
\([0.061,0.191].\) Si nous devions naïvement transformer l'intervalle de
confiance pour \(\lambda\) en un pour \(\phi\) en appliquant la fonction
\(g(\cdot)\) à chaque borne, nous obtiendrions plutôt \([0.063,\)
\(0.19],\) Bien que la différence soit minime ici, cela met en évidence
l'invariance. L'approximation gaussienne qui sous-tend le test de Wald
est fiable si la loi d'échantillonnage de la vraisemblance est presque
quadratique, ce qui se produit lorsque la fonction de vraisemblance est
à peu près symétrique de part et d'autre de l'estimateur du maximum de
vraisemblance.
...
\begin{example}[Tests de rapport de vraisemblance et du score pour
comparer modèles exponentiels et
Weibull]\protect\hypertarget{exm-weibull-scoretest}{}\label{exm-weibull-scoretest}

On peut procéder pour le calcul du test du score, mais l'entrée pour le
paramètre d'échelle du vecteur de score \(U({\widehat{\lambda}_1}, 0)\)
est nulle quand \(\alpha=1.\) L'estimateur contraint
\(\widehat{\lambda}_1=\overline{y}.\)

\begin{Shaded}
\begin{Highlighting}[]
\DocumentationTok{\#\# Test du score}
\CommentTok{\# Matrice de Fisher pour échantillon de taille 1}
\NormalTok{info\_weib }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(echelle, forme)\{ }
\NormalTok{  i11 }\OtherTok{\textless{}{-}}\NormalTok{ forme}\SpecialCharTok{*}\NormalTok{((forme }\SpecialCharTok{+} \DecValTok{1}\NormalTok{) }\SpecialCharTok{{-}} \DecValTok{1}\NormalTok{)}\SpecialCharTok{/}\NormalTok{(echelle}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{)}
\NormalTok{  i12 }\OtherTok{\textless{}{-}} \SpecialCharTok{{-}}\NormalTok{(}\DecValTok{1}\SpecialCharTok{+}\FunctionTok{digamma}\NormalTok{(}\DecValTok{1}\NormalTok{))}\SpecialCharTok{/}\NormalTok{echelle}
\NormalTok{  i22 }\OtherTok{\textless{}{-}}\NormalTok{ (}\DecValTok{1}\SpecialCharTok{+}\FunctionTok{digamma}\NormalTok{(}\DecValTok{1}\NormalTok{)}\SpecialCharTok{\^{}}\DecValTok{2}\SpecialCharTok{+}\DecValTok{2}\SpecialCharTok{*}\FunctionTok{digamma}\NormalTok{(}\DecValTok{1}\NormalTok{)}\SpecialCharTok{+}\NormalTok{pi}\SpecialCharTok{\^{}}\DecValTok{2}\SpecialCharTok{/}\DecValTok{6}\NormalTok{)}\SpecialCharTok{/}\NormalTok{(forme}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{)}
...
\NormalTok{\}}
\CommentTok{\# Statistique du score}
\NormalTok{score\_stat }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(echelle, forme, xdat)\{}
\NormalTok{  score\_w }\OtherTok{\textless{}{-}} \SpecialCharTok{{-}}\FunctionTok{gr\_nll\_weibull}\NormalTok{(}\FunctionTok{c}\NormalTok{(echelle, forme), }\AttributeTok{y =}\NormalTok{ xdat)}
\NormalTok{  finfo\_w }\OtherTok{\textless{}{-}} \FunctionTok{length}\NormalTok{(xdat)}\SpecialCharTok{*}\FunctionTok{info\_weib}\NormalTok{(echelle, forme)}
  ...
  \CommentTok{\# équivalent à score\_w[2]\^{}2 * solve(finfo\_w)[2,2]}
\NormalTok{\}}
\NormalTok{S }\OtherTok{\textless{}{-}} \FunctionTok{score\_stat}\NormalTok{(}\AttributeTok{echelle =} \FunctionTok{mean}\NormalTok{(attente), }\AttributeTok{forme =} \DecValTok{1}\NormalTok{, }\AttributeTok{xdat =}\NormalTok{ attente)}
\NormalTok{valp\_score }\OtherTok{\textless{}{-}} \FunctionTok{pchisq}\NormalTok{(S, }\AttributeTok{df =} \DecValTok{1}\NormalTok{, }\AttributeTok{lower.tail =} \ConstantTok{FALSE}\NormalTok{)}

\DocumentationTok{\#\# Statistique du rapport de vraisemblance}
\NormalTok{ll\_weib }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(xdat, echelle, forme)\{}
  \FunctionTok{sum}\NormalTok{(}\FunctionTok{dweibull}\NormalTok{(}\AttributeTok{x =}\NormalTok{ xdat, }\AttributeTok{scale =}\NormalTok{ echelle, }\AttributeTok{shape =}\NormalTok{ forme, }\AttributeTok{log =} \ConstantTok{TRUE}\NormalTok{))}
\NormalTok{\}}
\NormalTok{ll1 }\OtherTok{\textless{}{-}} \FunctionTok{ll\_weib}\NormalTok{(}\AttributeTok{xdat =}\NormalTok{ attente, }\AttributeTok{echelle =}\NormalTok{ mle\_weibull[}\DecValTok{1}\NormalTok{], }\AttributeTok{forme =}\NormalTok{ mle\_weibull[}\DecValTok{2}\NormalTok{])}
\NormalTok{ll0 }\OtherTok{\textless{}{-}} \FunctionTok{ll\_weib}\NormalTok{(}\AttributeTok{xdat =}\NormalTok{ attente, }\AttributeTok{echelle =} \FunctionTok{mean}\NormalTok{(attente), }\AttributeTok{forme =} \DecValTok{1}\NormalTok{)}
\NormalTok{lrt }\OtherTok{\textless{}{-}} \DecValTok{2}\SpecialCharTok{*}\NormalTok{(ll1}\SpecialCharTok{{-}}\NormalTok{ll0)}
\NormalTok{valp\_lrt }\OtherTok{\textless{}{-}} \FunctionTok{pchisq}\NormalTok{(lrt, }\AttributeTok{df =} \DecValTok{1}\NormalTok{, }\AttributeTok{lower.tail =} \ConstantTok{FALSE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

Bien que les statistiques soient asymptotiquement équivalentes et se
comportent toutes deux comme une variable khi-deux à nu degré de
liberté, leurs valeurs numériques diffèrent: 60.39 pour le test de
rapport de vraisemblance profilée, vs 24.86 pour le test du score. Les
deux statistiques indiquent sans ambiguïté un départ du modèle
exponentiel.
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Calcul des EMV pour l\textquotesingle{}espérance par substitution}
...
\NormalTok{     opt }\OtherTok{\textless{}{-}} \FunctionTok{optimize}\NormalTok{(}\AttributeTok{f =} \ControlFlowTok{function}\NormalTok{(alpha, mu)\{}
  ...
  \AttributeTok{interval =} \FunctionTok{c}\NormalTok{(}\FloatTok{0.1}\NormalTok{,}\DecValTok{10}\NormalTok{) }\CommentTok{\#région de la recherche}
\NormalTok{  )}
  \CommentTok{\# Retourner la valeur du négatif log vraisemblance et alpha\_mu}
...
\NormalTok{  \}}
  \CommentTok{\# Crée une base de donnée avec mu et les autres paramètres}
...
\NormalTok{\}}
\CommentTok{\# Créer une base de donnée avec la vraisemblance profilée}
...
\CommentTok{\# Calculer la racine directionnelle de R, disons r}
...
\CommentTok{\# Truc: ajuster un spline cubique pour obtenir les prédictions de mu en fonction de r}
\CommentTok{\# et utiliser ce modèle pour prédire les valeurs auxquelles la}
\CommentTok{\#  courbe intersecte les quantiles de la loi normale standard}
...
\CommentTok{\# Tracer la racine directionnelle de log vraisemblance {-} }
\CommentTok{\# Si le tracé est linéaire, cela indique que la vraisemblance}
\CommentTok{\# profilée est quadratique (normale)}
...
\CommentTok{\# Créer un graphique de la log vraisemblance profilée}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{vraisemblance_files/figure-pdf/fig-profile-mu-weibull-1.pdf}
...
critère \textbf{cohérent}, ce qui signifie qu'il choisira le vrai modèle
parmi un ensemble de modèles avec une probabilité de 1 lorsque
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{regression-lineaire_files/figure-pdf/fig-edacollege-1.pdf}
...
\CommentTok{\#\textgreater{}  Min.   :0.000   Min.   :0.00   open{-}ended:407   Min.   : 0.25  }
\CommentTok{\#\textgreater{}  1st Qu.:0.000   1st Qu.:0.00   quantity  :462   1st Qu.: 5.00  }
\CommentTok{\#\textgreater{}  Median :1.000   Median :1.00                    Median :10.00  }
\CommentTok{\#\textgreater{}  Mean   :0.596   Mean   :0.73                    Mean   :10.69  }
\CommentTok{\#\textgreater{}  3rd Qu.:1.000   3rd Qu.:1.00                    3rd Qu.:15.00  }
\CommentTok{\#\textgreater{}  Max.   :1.000   Max.   :1.00                    Max.   :25.00  }
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{regression-lineaire_files/figure-pdf/fig-donation-moon-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{regression-lineaire_files/figure-pdf/fig-autoquad2d-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{images/hyperplan_auto.png}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{regression-lineaire_files/figure-pdf/fig-vertdist-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{regression-lineaire_files/figure-pdf/fig-predinterval-1.png}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{regression-lineaire_files/figure-pdf/fig-insuranceinter1-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{regression-lineaire_files/figure-pdf/fig-interaction-slope-1.pdf}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{regression-lineaire_files/figure-pdf/fig-2by2-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{regression-lineaire_files/figure-pdf/fig-interaction-ST-1.pdf}
...
\FunctionTok{emmip}\NormalTok{(}\AttributeTok{object =}\NormalTok{ emm, }
        ...
        \AttributeTok{CIs =} \ConstantTok{TRUE}\NormalTok{) }\SpecialCharTok{+} 
\NormalTok{  MetBrewer}\SpecialCharTok{::}\FunctionTok{scale\_color\_met\_d}\NormalTok{(}\AttributeTok{name =} \StringTok{"Hiroshige"}\NormalTok{) }\SpecialCharTok{+}
...
\begin{center}
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{regression-lineaire_files/figure-pdf/unnamed-chunk-16-1.pdf}
\end{center}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedleft\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.0597}}
...
\CommentTok{\#\textgreater{}  not black   2.38 0.1420 699     2.11     2.66}
\CommentTok{\#\textgreater{}  black       1.68 0.1490 699     1.38     1.97}
\CommentTok{\#\textgreater{} }
...
\CommentTok{\#\textgreater{}  peeking       2.56 0.108 699     2.35     2.77}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{regression-lineaire_files/figure-pdf/fig-zerocor-1.pdf}
...
\CommentTok{\#\textgreater{}   (Intercept) sexe1 echelon1 echelon2 service}
\CommentTok{\#\textgreater{} 1           1    {-}1       {-}1       {-}1      18}
\CommentTok{\#\textgreater{} 2           1    {-}1       {-}1       {-}1      16}
\CommentTok{\#\textgreater{} 3           1    {-}1        1        0       3}
\FunctionTok{head}\NormalTok{(}\FunctionTok{model.matrix}\NormalTok{(modB), }\AttributeTok{n =} \DecValTok{3}\NormalTok{L)}
\CommentTok{\#\textgreater{}   sexefemme sexehomme echelon1 echelon2 service}
\CommentTok{\#\textgreater{} 1         0         1       {-}1       {-}1  0.0296}
\CommentTok{\#\textgreater{} 2         0         1       {-}1       {-}1 {-}0.1241}
\CommentTok{\#\textgreater{} 3         0         1        1        0 {-}1.1237}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{regression-lineaire_files/figure-pdf/fig-addedvariableplots-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{regression-lineaire_files/figure-pdf/fig-outliers-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{regression-lineaire_files/figure-pdf/fig-regdiaglin-1.pdf}
...
\(F\) incluent des estimations de \(\widehat{\sigma}^2.\)
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{regression-lineaire_files/figure-pdf/fig-diagfitvalhomosce-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{regression-lineaire_files/figure-pdf/fig-simuWelchnull-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{regression-lineaire_files/figure-pdf/fig-plotLevelIndep-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{regression-lineaire_files/figure-pdf/fig-timeresidplot-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{regression-lineaire_files/figure-pdf/fig-correlogram-1.pdf}
...
pas exacte), pourvu que l'espérance existe, à cause du théorème de la
limite centrale. Il est important de garder à l'esprit que, pour les
variables explicatives catégorielles, la taille de l'échantillon dans
chaque sous-groupe doit être suffisamment importante pour que le
théorème de la limite centrale s'applique, puisque les coefficients
représentent la moyenne du sous-groupe. En revanche, les résultats et
tests qui capitalisent sur la loi des aléas (par exemple, les tests pour
les aberrances basés sur le maximum des résidus studentisés, ou les
...
voir la Section~\ref{sec-transfo}. Ceci peut être évalué en regardant le
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{regression-lineaire_files/figure-pdf/fig-qqplotresid-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{regression-lineaire_files/figure-pdf/fig-qqplotsbad-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{regression-lineaire_files/figure-pdf/fig-diagplotscollege-1.pdf}

}

\caption{\label{fig-diagplotscollege}Diagnostics graphiques pour les
données e salaires dans les collèges: résidus ordinaires versus valeurs
ajustées (coin supérieur gauche), valeur absolue des résidus studentisés
avec la méthode du canif (coin supérieur droit), boîte à moustaches de
ces mêmes résidus (coin inférieur gauche) et diagramme quantile-quantile
des résidus après soustraction de la traîne (coin inférieur droit).
L'hétéroscédasticité de groupe est bien visible.}
...
\begin{center}
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{regression-lineaire_files/figure-pdf/unnamed-chunk-22-1.pdf}
\end{center}
...
(\citeproc{ref-Box.Cox:1964}{Box et Cox 1964}), \begin{align*}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{regression-lineaire_files/figure-pdf/fig-poisonplots-1.pdf}
...
\href{https://lindeloev.github.io/tests-as-linear/linear_tests_cheat_sheet.pdf}{peuvent
être formulés à l'aide d'une régression linéaire}, tandis que
\href{https://threadreaderapp.com/thread/1286420597505892352.html}{des
modèles aussi divers que les arbres, les composantes principales et les
réseaux neuronaux profonds ne sont que des modèles de régression
linéaire déguisés}. Ce qui change sous le capot d'un modèle à l'autre,
c'est la méthode d'optimisation (par exemple, les moindres carrés
ordinaires, l'optimisation sous contrainte ou la descente de gradient
stochastique) et le choix des variables explicatives entrant dans le
modèle (bases de splines pour la régression non paramétrique, variable
indicatrice sélectionnée via une recherche gloutonne pour les arbres,
