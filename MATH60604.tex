...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, coltitle=black, colframe=quarto-callout-important-color-frame, colbacktitle=quarto-callout-important-color!10!white, colback=white, opacitybacktitle=0.6, left=2mm, rightrule=.15mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Objectifs d'apprentissage}, bottomtitle=1mm, leftrule=.75mm, arc=.35mm, breakable, toprule=.15mm, toptitle=1mm, bottomrule=.15mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, coltitle=black, colframe=quarto-callout-caution-color-frame, colbacktitle=quarto-callout-caution-color!10!white, colback=white, opacitybacktitle=0.6, left=2mm, rightrule=.15mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Mise en garde}, bottomtitle=1mm, leftrule=.75mm, arc=.35mm, breakable, toprule=.15mm, toptitle=1mm, bottomrule=.15mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, coltitle=black, colframe=quarto-callout-important-color-frame, colbacktitle=quarto-callout-important-color!10!white, colback=white, opacitybacktitle=0.6, left=2mm, rightrule=.15mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, bottomtitle=1mm, leftrule=.75mm, arc=.35mm, breakable, toprule=.15mm, toptitle=1mm, bottomrule=.15mm, opacityback=0]
...
proportion de donateurs à un organisme de charité. Les participants au
panel en ligne avaient la possibilité de gagner 25\$ et de faire don
d'une partie de cette somme à l'organisme de leur choix. Les données
fournies incluent uniquement les personnes qui n'ont pas dépassé ce
montant et qui ont indiqué avoir fait un don d'un montant non nul.

\end{example}

\begin{example}[Un emballage en papier supplémentaire est-il considéré
...
écologique lorsque la quantité de carton ou de papier entourant la boîte
...
\texttt{proportion} d'emballage en papier (soit aucun, soit la moitié de
...
des nouvelles prédictions est la somme de l'incertitude due aux
estimateurs (basés sur des données aléatoires) et de la variance
intrinsèque des observations en supposant que la nouvelle observation
est indépendante de celles utilisées pour estimer les coefficients,
\begin{align*}
...
la \texttt{proportion} de papier par rapport au plastique, les valeurs
...
et que les ratios testés dans l'expérience sont 0 (pas de papier), 0.5,
1 et 2 uniquement. La droite centrale donne la prédiction des individus
lorsque nous faisons varier la proportion papier/plastique. En examinant
...
de papier par rapport au plastique, avec des observations décalées
...
\toprule\noalign{}
moyenne & borne inf. (IC) & borne sup. (IC) \\
\midrule\noalign{}
\endfirsthead
\toprule\noalign{}
moyenne & borne inf. (IC) & borne sup. (IC) \\
...
le score \texttt{pef} change avec le ratio papier/plastique.
...
\(\mathscr{H}_0 : \beta_{k+1}=\beta_{k+2}=\cdots=\beta_p=0\) (on
pourrait permuter les colonnes de la matrice du modèle pour obtenir
cette configuration). L'hypothèse globale spécifie que \((p-k)\) des
paramètres \(\beta\) sont nuls. Le \emph{modèle restreint} correspondant
à l'hypothèse nulle ne contient que les covariables pour lesquelles
\(\beta_j \neq 0\), \begin{align*}
...
uniquement à la différence entre les groupes (par opposition à l'effet
...
particulière entre des groupes de traitement. Extrait du résumé :
...
\NormalTok{mod\_post }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(posttest1 }\SpecialCharTok{\textasciitilde{}}\NormalTok{ group }\SpecialCharTok{+}\NormalTok{ pretest1,}
               \AttributeTok{data =}\NormalTok{ BSJ92)}
\NormalTok{car}\SpecialCharTok{::}\FunctionTok{Anova}\NormalTok{(mod\_post, }\AttributeTok{type =} \DecValTok{3}\NormalTok{) }\CommentTok{\# tests F}
...
\CommentTok{\#\textgreater{} {-}{-}{-}}
\CommentTok{\#\textgreater{} Signif. codes:  0 \textquotesingle{}***\textquotesingle{} 0.001 \textquotesingle{}**\textquotesingle{} 0.01 \textquotesingle{}*\textquotesingle{} 0.05 \textquotesingle{}.\textquotesingle{} 0.1 \textquotesingle{} \textquotesingle{} 1}
\CommentTok{\# Ci{-}dessus compare le modèle avec pretest1 et group,}
\CommentTok{\# versus sans l\textquotesingle{}une ou l\textquotesingle{}autre des variables}
...
PEF en fonction de la proportion de papier pour les données de
...
proportion de plastique. Pour ce dernier, nous pourrions comparer le
modèle de régression linéaire (dans lequel le score PEF augmente
linéairement avec la proportion de papier par rapport au plastique),
\begin{align*}
 \mathsf{E}(\texttt{pef} \mid \texttt{proportion}) = \beta_0 + \beta_1\texttt{proportion},
 \end{align*} à l'ANOVA qui permet à chacun des quatre groupes d'avoir
des moyennes différentes. \begin{align*}
...
Les auteurs souhaitaient comparer zéro papier avec d'autres choix: nous
...
respect de l'environnement augmente avec la quantité de papier utilisée
...
rapport au papier/plastique. Il y a cependant de fortes indications,
