...
Munroe}. Text alternatif: Frazzled scientists are requesting that
...
\caption{\label{fig-uniformsamp2}Diagrammes à bande de données tirées
d'une loi uniforme (haut) et d'une loi non-uniforme (bas) pour des
tailles d'échantillons de 10, 100, 1000 and 10 000 (de gauche à
droite).}
...
moyenne d'une population normale \(\mathsf{normale}(0,1)\) pour 100
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-caution-color-frame, bottomrule=.15mm, opacitybacktitle=0.6, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Mise en garde}, opacityback=0, left=2mm, breakable, toptitle=1mm, toprule=.15mm, colbacktitle=quarto-callout-caution-color!10!white, bottomtitle=1mm, coltitle=black, titlerule=0mm, leftrule=.75mm, arc=.35mm, rightrule=.15mm, colback=white]
